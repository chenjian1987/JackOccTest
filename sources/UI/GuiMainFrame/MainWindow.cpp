...
void MainWindow::createActions() 
{
    ...
    //测试 简化 ShapeUpgrade_UnifySameDomain
    m_actionShapeUpgradeSimpleTest = new QAction(QIcon(simpleSolidPath), QString::fromLocal8Bit("Test简化"), m_panelSolid);
    ...
    m_actionBsplineCurvePointEvalCompareTest = new QAction(
        QIcon(QString(exePath + "/Resource/Arc3Points.png")),
        QString::fromLocal8Bit("D0点值求解(De Boor)验证"),
        m_bsplineCurveManager);
